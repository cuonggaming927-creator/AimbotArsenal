...
StrokeGradient.Color = ColorSequence.new({
     ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),     -- Xanh cyan sáng
    ColorSequenceKeypoint.new(0.2, Color3.fromRGB(255, 255, 255)),   -- Giữ xanh
    ColorSequenceKeypoint.new(0.3, Color3.fromRGB(255, 255, 255)), -- Trắng bắt đầu sớm
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 255)), -- Trắng giữa
    ColorSequenceKeypoint.new(0.7, Color3.fromRGB(255, 255, 255)), -- Trắng kéo dài
    ColorSequenceKeypoint.new(0.8, Color3.fromRGB(255, 255, 255)),   -- Xanh trở lại
    ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255))      -- Xanh kết thúc
})
